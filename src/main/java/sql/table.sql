...
VALUES
    ('Brand1', 'www.brand1.com', 'Description1'),
...
-- Insert data into shareHolder_brand table (relationships)
...
VALUES
    ('User1', 'user1', 'user1@example.com', 'password1'),
